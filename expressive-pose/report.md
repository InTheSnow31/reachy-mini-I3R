...
The whole scripts are available on the following Github repo : [InTheSnow31/reachy_mini](https://github.com/InTheSnow31/reachy_mini). The experiments made throughout this report are available in the "experiment" folder.
